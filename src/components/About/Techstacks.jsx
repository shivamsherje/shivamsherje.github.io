  ...
  return (
    <>
      <div className="section main" data-aos="fade-right">
        ...
        <h2 style={{color:"#2ECBE9" , fontSize:"40px"}}   className="section__title different">Tech Stack & Tools</h2>
        
        <div className="techsection">
          <div >
            {/* <SiJavascript  /> */}
            <img style={{width:"70px" , height:"70px"}} src={javascript}/>
            <h5 className="techname" style={{color:"yellowgreen", fontSize:"19px"}}>Javascript</h5>
          </div>
          <div>
            {/* <SiHtml5 /> */}
          ...
          <div>
            <SiMaterialui />
            <h5 style={{color:"yellowgreen",fontSize:"19px"}}>Material Ui</h5>
          </div>        
          <div>
            {/* <VscGithub /> */}
